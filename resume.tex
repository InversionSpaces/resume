...
\entry {\interval{2023}{\ru{н.в.}\en{today}}}
{Fluence Labs - Aqua Language - \ru{Разработчик компилятора}\en{Compiler Engineer} - Scala}
{\ru{Разработка компилятора Aqua - языка оркестрации вычислений в одноранговой сети Fluence}\en{Developing compiler for Aqua - language for computation orchestration in Fluence peer-to-peer network}:
    \begin{itemize}
        \item \ru{Разработка на всех стадиях компиляции}\en{Development of all compilation stages}: parsing, type checking, IR passes, code generation.
        \item \ru{Проектирование и реализация}\en{Design and implementation}: boolean algebra, math optimizations, tracing code augmentation.
        \item \ru{Разработка и поддеражание}\en{Development and maintenance}: LSP server, VSCode extension.
    \end{itemize}
}
